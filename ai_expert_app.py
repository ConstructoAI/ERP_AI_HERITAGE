   ...
   with center_col:
       ...
       st.markdown("""
           <div class="main-header">
               ...
               <p>La plateforme intelligente qui révolutionne vos projets de construction.</p>
           </div>
       """, unsafe_allow_html=True)
       ...
       st.markdown("<h3 style='text-align: center; font-weight: normal;'>Excellence en construction depuis quatre décennies</h3>", unsafe_allow_html=True)
       st.markdown("<p style='text-align: center; color: var(--text-color-light);'>Notre objectif est de fournir des solutions complètes de qualité pour tous vos projets de construction</p>", unsafe_allow_html=True)
       st.markdown(" ")
       ...
       with col1:
           ...
           <div class="info-card" style="--delay: 1">
               ...
               <p>Utilisation de l'Intelligence Artificielle pour fournir une expertise en construction, planification, gestion de chantier et conformité.</p>
           </div>
           """, unsafe_allow_html=True)
       with col2:
           st.markdown("""
           <div class="info-card" style="--delay: 2">
               ...
               <p>Une équipe passionnée avec plus de 40 ans d'expérience dans le secteur de la construction au Québec.</p>
           </div>
           """, unsafe_allow_html=True)
       with col3:
           st.markdown("""
       ...
       st.markdown("<h2 style='text-align: center;'>La plateforme intelligente pour la construction</h2>", unsafe_allow_html=True)
       st.markdown("<p style='text-align: center; color: var(--text-color-light);'>Gagnez du temps et optimisez vos projets grâce à notre IA conçue pour la construction. Une plateforme complète pour vous assister dans vos besoins.</p>", unsafe_allow_html=True)
       st.markdown(" ")
       ...
       with fcol3:
           ...
           <div class="info-card" style="--delay: 3">
               ...
               <p>Un assistant IA spécialisé en construction répondant à vos questions techniques en temps réel.</p>
           </div>
           """, unsafe_allow_html=True)
       st.markdown(" ")
       ...
       with fcol5:
           ...
           <div class="info-card" style="--delay: 5">
               ...
               <p>Base de connaissances complète sur nos matériaux et services de construction.</p>
           </div>
           """, unsafe_allow_html=True)
       with fcol6:
           st.markdown("""
           <div class="info-card" style="--delay: 6">
               ...
               <p>Outils d'analyse et d'optimisation des processus basés sur notre expertise en construction.</p>
           </div>
           """, unsafe_allow_html=True)
       st.markdown(" ")
...
<body>
   <div class="single-message-container">
       ...
       <div class="export-footer">
           ...
           <p>Assistant IA Spécialisé en Construction au Québec</p>
...
with main_container:
   if 'expert_advisor' in st.session_state:
       ...
       <div class="main-header">
           ...
           <p>Votre expert en construction - Posez vos questions ou téléversez des documents</p>
       </div>
       """, unsafe_allow_html=True)
