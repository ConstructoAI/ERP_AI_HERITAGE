...
# Constantes pour les produits de construction (adaptées pour le Québec)
CATEGORIES_PRODUITS = ["Béton", "Bois", "Acier structural", "Isolation", "Plâtre", "Toiture", "Plomberie", "Électricité", "Quincaillerie", "Finition", "Revêtements", "Portes et fenêtres", "Armature", "Granulats"]
UNITES_VENTE = ["unité", "sac", "m", "m²", "m³", "pièce", "paquet", "boîte", "gallon", "lot", "pi", "pi²", "pi³", "vg³", "pi linéaire", "tonne", "palette"]
NUANCES_MATERIAUX = {
    "Béton": ["20 MPa", "25 MPa", "30 MPa", "35 MPa", "40 MPa", "Fibré", "Léger", "Autoplaçant"],
    "Bois": ["Pin", "Épinette", "Sapin", "Chêne", "Érable", "Traité", "Laminé", "LSL", "LVL", "Glulam"],
    "Acier structural": ["W150", "W200", "W250", "W310", "HSS", "Galvanisé", "400W", "300W"],
    "Isolation": ["R-12", "R-20", "R-24", "R-28", "R-32", "Rigide", "Giclée", "Polyuréthane", "Cellulose"],
    "Toiture": ["Asphalte", "Membrane TPO", "EPDM", "Tôle", "Bardeaux", "Membrane torchée"],
    "Plomberie": ["PVC", "Cuivre", "PEX", "ABS", "Fonte", "Acier galvanisé"],
    "Électricité": ["14 AWG", "12 AWG", "10 AWG", "BX", "Romex", "THWN"],
    "Revêtements": ["Vinyle", "Fibre de ciment", "Brique", "Pierre", "Crépi", "Tôle"],
    "Portes et fenêtres": ["PVC", "Aluminium", "Bois", "Hybride", "Double vitrage", "Triple vitrage"],
    "Armature": ["10M", "15M", "20M", "25M", "30M", "Treillis soudé"],
    "Granulats": ["0-5mm", "5-14mm", "14-20mm", "Sable", "Gravier", "Concassé"],
    "Autres": ["Standard", "Premium", "Commercial"]
}
...
class GestionnaireProduits:
    ...
    def _create_demo_products(self):
        """Crée des produits de démonstration pour la construction"""
        if not self.use_sqlite:
            return
        ...
        try:
            produits_demo = [
                {
                    'code_produit': 'BET-SAC-001',
                    'nom': 'Béton prémélangé 30 MPa',
                    'description': 'Sac de béton prêt à l\'emploi, résistance 30 MPa',
                    'categorie': 'Béton',
                    'materiau': 'Béton',
                    'nuance': '30 MPa',
                    'dimensions': '30kg/sac',
                    'unite_vente': 'sac',
                    'prix_unitaire': 8.95,
                    'stock_disponible': 250.0,
                    'stock_minimum': 100.0,
                    'fournisseur_principal': 'Lafarge Canada',
                    'notes_techniques': 'Temps de prise: 24-48h. Résistant au gel/dégel.',
                    'actif': 1
                },
                {
                    'code_produit': 'BOIS-2X4-001',
                    'nom': 'Montant 2x4x8 épinette',
                    'description': 'Bois de charpente séché, qualité construction',
                    'categorie': 'Bois',
                    'materiau': 'Bois',
                    'nuance': 'Épinette',
                    'dimensions': '2"x4"x8\'',
                    ...
                    'stock_minimum': 200.0,
                    'fournisseur_principal': 'Goodfellow',
                    'notes_techniques': 'Certifié séché au four (KD). Grade construction.',
                    'actif': 1
                },
                {
                    'code_produit': 'ISO-LAI-001',
                    'nom': 'Laine minérale R-20',
                    'description': 'Isolant en laine minérale pour murs extérieurs',
                    'categorie': 'Isolation',
                    'materiau': 'Laine minérale',
                    'nuance': 'R-20',
                    'dimensions': '16"x48"x5.5"',
                    'unite_vente': 'paquet',
                    'prix_unitaire': 52.99,
                    'stock_disponible': 120.0,
                    'stock_minimum': 50.0,
                    'fournisseur_principal': 'Roxul/Rockwool',
                    'notes_techniques': 'Résistant au feu. Insonorisant.',
                    'actif': 1
                },
                {
                    'code_produit': 'PLA-GYP-001',
                    'nom': 'Gypse 1/2" régulier',
                    'description': 'Panneau de gypse standard pour intérieur',
                    'categorie': 'Plâtre',
                    'materiau': 'Gypse',
                    'nuance': 'Standard',
                    ...
                    'unite_vente': 'unité',
                    'prix_unitaire': 13.49,
                    'stock_disponible': 300.0,
                    'stock_minimum': 100.0,
                    'fournisseur_principal': 'CertainTeed',
                    'notes_techniques': 'Type X disponible pour résistance au feu.',
                    'actif': 1
                },
                {
                    'code_produit': 'BAR-ARM-001',
                    'nom': 'Barre d\'armature 15M',
                    'description': 'Acier d\'armature pour béton armé',
                    'categorie': 'Armature',
                    'materiau': 'Acier',
                    'nuance': '15M',
                    'dimensions': '15mm x 6m',
                    'unite_vente': 'pièce',
                    'prix_unitaire': 18.95,
                    'stock_disponible': 200.0,
                    'stock_minimum': 50.0,
                    'fournisseur_principal': 'AGF Steel',
                    'notes_techniques': 'Norme CSA G30.18. Limite élastique 400 MPa.',
                    'actif': 1
                },
                {
                    'code_produit': 'TOI-BAR-001',
                    'nom': 'Bardeaux asphalte GAF',
                    'description': 'Bardeaux d\'asphalte architectural 30 ans',
                    'categorie': 'Toiture',
                    'materiau': 'Asphalte',
                    'nuance': 'Asphalte',
                    'dimensions': '1m² par bardeau',
                    'unite_vente': 'paquet',
                    'prix_unitaire': 89.99,
                    'stock_disponible': 150.0,
                    'stock_minimum': 75.0,
                    'fournisseur_principal': 'GAF Canada',
                    'notes_techniques': 'Garantie 30 ans. Résistant vents 180 km/h.',
                    'actif': 1
                },
                {
                    'code_produit': 'REV-VIN-001',
                    'nom': 'Revêtement vinyle blanc',
                    'description': 'Revêtement extérieur vinyle horizontal',
                    ...
                    'unite_vente': 'pi²',
                    'prix_unitaire': 4.25,
                    'stock_disponible': 800.0,
                    'stock_minimum': 200.0,
                    'fournisseur_principal': 'Kaycan',
                    'notes_techniques': 'Garantie décoloration 25 ans. Expansion thermique compensée.',
                    'actif': 1
                }
            ]
            ...
            st.info("✅ Produits de démonstration construction créés")
