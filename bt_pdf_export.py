...
def test_pdf_generation():
    ...
    test_data = {
        ...
        'safety_notes': 'Port des EPI obligatoire en tout temps. Attention particulière lors des travaux en hauteur. Respect des normes CNESST.',
        ...
        'tasks': [
            ...
            {
                'operation': '1012 - Coffrage Béton',
                'description': 'Installation coffrage pour fondations',
                'quantity': 1,
                'planned_hours': 5.7,
                'actual_hours': 0.0,
        ...
        'materials': [
            {
                'name': 'Béton 30 MPa certifié CSA',
                'description': 'Barre rectangulaire 40x20x3mm, galvanisation à chaud selon norme ASTM A653',
                'quantity': 12.5,
                'unit': 'm',
                'fournisseur': 'Béton Provincial Inc. Fournisseur Certifié',
                'available': 'yes',
                'notes': 'Stock vérifié, qualité contrôlée, certificats disponibles'
            },
            {
                'name': 'Armature d\'acier 15M haute performance',
                'description': 'Barres d\'armature 15mm norme CSA G30.18 pour béton armé',
                'quantity': 5.0,
                'unit': 'kg',
                'fournisseur': 'Acier AGF Inc. Division Construction',
                'available': 'ordered',
