...
class TimeTrackerUnified:
    """
    Système de pointage spécialisé pour la construction au Québec
    Pointage granulaire sur opérations de chantiers et postes construction
    Interface optimisée pour le suivi des travaux de construction
    Support complet des tâches construction depuis les Bons de Travail
    Mapping automatique postes → étapes de construction québécoises
    ...
    v2.2: Mise à jour automatique de l'étape de construction selon le poste de travail
    """
    
    # Mapping entre les postes de travail construction et les étapes de construction Québec
    POSTE_TO_TACHE_MAPPING = {
        # Étapes de planification et conception
        "PROGRAMMATION": "Planification et conception",
        "BUREAU": "Planification et conception",
        "CONCEPTION": "Planification et conception",
        "DESSIN": "Planification et conception",
        "ESTIMATION": "Planification et conception",
        "ARPENTAGE": "Planification et conception",
        
        # Préparation et terrassement
        "EXCAVATION": "Fondations et excavation",
        "EXCAVATRICE": "Fondations et excavation",
        "BULLDOZER": "Préparation du terrain",
        "NIVELEUSE": "Préparation du terrain",
        "TERRASSEMENT": "Préparation du terrain",
        "DÉBLAI": "Préparation du terrain",
        "REMBLAI": "Préparation du terrain",
        
        # Fondations
        "FONDATION": "Fondations et excavation",
        "COFFRAGE": "Fondations et excavation",
        "COULAGE BÉTON": "Fondations et excavation",
        "ARMATURE": "Fondations et excavation",
        "SEMELLE": "Fondations et excavation",
        
        # Structure et charpente bois
        "CHARPENTE": "Structure et charpente",
        "CHARPENTIER": "Structure et charpente",
        "SCIE CIRCULAIRE": "Structure et charpente",
        "SCIE À ONGLET": "Structure et charpente",
        "ASSEMBLAGE": "Structure et charpente",
        "MONTAGE": "Structure et charpente",
        "FERMES TOIT": "Structure et charpente",
        "SOLIVES": "Structure et charpente",
        "POUTRELLES": "Structure et charpente",
        "PONTAGE": "Structure et charpente",
        "CONTREPLAQUÉ": "Structure et charpente",
        "OSB": "Structure et charpente",
        
        # Construction acier (pour commerciale/industrielle)
        "SOUDURE": "Structure et charpente",
        "SOUDURE ACIER": "Structure et charpente",
        "MONTAGE ACIER": "Structure et charpente",
        
        # Toiture
        "TOITURE": "Toiture et étanchéité",
        "COUVREUR": "Toiture et étanchéité",
        "PONTAGE TOIT": "Toiture et étanchéité",
        "MEMBRANE": "Toiture et étanchéité",
        "BARDEAUX": "Toiture et étanchéité",
        "GOUTTIÈRES": "Toiture et étanchéité",
        "SOLIN": "Toiture et étanchéité",
        
        # Isolation et étanchéité
        "ISOLATION": "Isolation et pare-vapeur",
        "ISOLANT": "Isolation et pare-vapeur",
        "PARE-VAPEUR": "Isolation et pare-vapeur",
        "LAINE MINÉRALE": "Isolation et pare-vapeur",
        "MOUSSE ISOLANTE": "Isolation et pare-vapeur",
        
        # Plomberie
        "PLOMBERIE": "Plomberie brute",
        "PLOMBIER": "Plomberie brute",
        "TUYAUTERIE": "Plomberie brute",
        "PEX": "Plomberie brute",
        "CUIVRE": "Plomberie brute",
        "PLOMBERIE FINITION": "Plomberie de finition",
        "FIXTURES": "Plomberie de finition",
        
        # Électricité
        "ÉLECTRICITÉ": "Électricité brute",
        "ÉLECTRICIEN": "Électricité brute",
        "CÂBLAGE": "Électricité brute",
        "PANNEAU": "Électricité brute",
        "CONDUITS": "Électricité brute",
        "ÉLECTRICITÉ FINITION": "Électricité de finition",
        "PRISES": "Électricité de finition",
        "ÉCLAIRAGE": "Électricité de finition",
        
        # Cloisons et gypse
        "CLOISONS": "Cloisons et structures internes",
        "CLOISON SÈCHE": "Cloisons et structures internes",
        "GYPROC": "Cloisons et structures internes",
        "GYPSE": "Cloisons et structures internes",
        "JOINTS": "Cloisons et structures internes",
        "FINITION GYPSE": "Cloisons et structures internes",
        
        # Portes et fenêtres
        "PORTES": "Portes et fenêtres",
        "FENÊTRES": "Portes et fenêtres",
        "CADRAGE": "Portes et fenêtres",
        "MOULURES": "Portes et fenêtres",
        
        # Revêtements extérieurs
        "REVÊTEMENT": "Revêtement extérieur",
        "BARDAGE": "Revêtement extérieur",
        "VINYLE": "Revêtement extérieur",
        "BRIQUE": "Revêtement extérieur",
        "CRÉPI": "Revêtement extérieur",
        
        # Revêtements de sol
        "PLANCHER": "Revêtements de sol",
        "CARRELAGE": "Revêtements de sol",
        "CÉRAMIQUE": "Revêtements de sol",
        "BOIS FRANC": "Revêtements de sol",
        "STRATIFIÉ": "Revêtements de sol",
        
        # Peinture et finition
        "PEINTURE": "Peinture et finition",
        "APPRÊT": "Peinture et finition",
        "FINITION": "Peinture et finition",
        "TEINTURE": "Peinture et finition",
        "VERNIS": "Peinture et finition",
        
        # Contrôle et inspection
        "INSPECTION": "Inspection finale",
        "CONTRÔLE QUALITÉ": "Inspection finale",
        "VÉRIFICATION": "Inspection finale",
        
        # Nettoyage et livraison
        "NETTOYAGE": "Nettoyage final", 
        "MÉNAGE": "Nettoyage final",
        "LIVRAISON": "Nettoyage final",
        
        # Général
        "MANUTENTION": "Structure et charpente",
        "RÉCEPTION": "Planification et conception",
        "GÉNÉRAL": "Planification et conception",
        "DIVERS": "Planification et conception"
    }
    
    def __init__(self, db):
        self.db = db
        logger.info("TimeTracker Construction Québec initialisé")
    
    # =========================================================================
    # MÉTHODES CORE DE POINTAGE - CHANTIERS CONSTRUCTION UNIQUEMENT
    # =========================================================================
