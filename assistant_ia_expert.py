            ...
            if not os.path.exists(profile_dir_path):
                ...
                if not os.path.exists(default_profile_path):
                    with open(default_profile_path, "w", encoding="utf-8") as f:
                        f.write("""Expert ERP Construction Québec
Je suis un expert spécialisé dans la gestion ERP pour l'industrie de la construction au Québec. 
J'ai accès aux données de votre système ERP incluant:
- Projets de construction résidentielle et commerciale
- Inventaire matériaux et équipements de construction
- CRM et gestion des clients/entrepreneurs/sous-traitants
- Ressources humaines et conformité CCQ/RBQ
- Bons de travail et suivi de chantiers
- Analyses et statistiques de performance chantiers
- Conformité construction Québec (normes CSA, BNQ, Code construction)

Je peux vous aider à analyser vos données, optimiser vos processus de construction, et répondre à toutes vos questions concernant votre activité de construction au Québec.""")
    ...
    def _show_sidebar(self):
        ...
        with st.expander("💡 Aide recherche"):
            ...
            **Recherche web:**
            ...
            - Ex: `/search normes CSA construction Québec`
            """)
...
**Questions générales:**
- Posez directement vos questions sur la construction au Québec
