...
# ===============================
# POSTES DE TRAVAIL CONSTRUCTION QUÉBEC
# ===============================

POSTES_CONSTRUCTION_QUEBEC = [
    # ===== TERRASSEMENT ET FONDATIONS =====
    {"nom": "Excavation et terrassement", "departement": "TERRASSEMENT", "capacite_heures": 8, "cout_heure": 45, "description": "Excavation, nivellement, préparation terrain"},
    {"nom": "Coffrage fondations", "departement": "BÉTON", "capacite_heures": 8, "cout_heure": 40, "description": "Coffrage murs et semelles de fondation"},
    {"nom": "Coulage béton fondations", "departement": "BÉTON", "capacite_heures": 6, "cout_heure": 42, "description": "Coulage et finition béton fondations"},
    {"nom": "Remblayage", "departement": "TERRASSEMENT", "capacite_heures": 8, "cout_heure": 35, "description": "Remblayage et compactage autour fondations"},
    
    # ===== STRUCTURE ET CHARPENTE =====
    {"nom": "Charpente murs", "departement": "CHARPENTE", "capacite_heures": 8, "cout_heure": 38, "description": "Montage ossature bois 2x4, 2x6"},
    {"nom": "Charpente toit", "departement": "CHARPENTE", "capacite_heures": 8, "cout_heure": 42, "description": "Fermes de toit, solives, chevrons"},
    {"nom": "Pose poutrelles", "departement": "CHARPENTE", "capacite_heures": 8, "cout_heure": 45, "description": "Installation poutrelles et solives de plancher"},
    {"nom": "Planchers OSB", "departement": "CHARPENTE", "capacite_heures": 8, "cout_heure": 35, "description": "Pose contreplaqué et OSB planchers"},
    
    # ===== TOITURE =====
    {"nom": "Pontage toiture", "departement": "TOITURE", "capacite_heures": 8, "cout_heure": 36, "description": "Pontage OSB ou contreplaqué toiture"},
    {"nom": "Membrane toiture", "departement": "TOITURE", "capacite_heures": 8, "cout_heure": 38, "description": "Installation membrane d'étanchéité"},
    {"nom": "Pose bardeaux", "departement": "TOITURE", "capacite_heures": 8, "cout_heure": 40, "description": "Installation bardeaux d'asphalte"},
    {"nom": "Gouttières", "departement": "TOITURE", "capacite_heures": 6, "cout_heure": 42, "description": "Installation système gouttières"},
    
    # ===== ISOLATION ET ÉTANCHÉITÉ =====
    {"nom": "Isolation murs", "departement": "ISOLATION", "capacite_heures": 8, "cout_heure": 32, "description": "Pose isolant laine ou rigide"},
    {"nom": "Pare-vapeur", "departement": "ISOLATION", "capacite_heures": 6, "cout_heure": 28, "description": "Installation pare-vapeur polyéthylène"},
    {"nom": "Calfeutrage", "departement": "ISOLATION", "capacite_heures": 6, "cout_heure": 35, "description": "Calfeutrant fenêtres et joints"},
    
    # ===== PLOMBERIE =====
    {"nom": "Plomberie brute", "departement": "PLOMBERIE", "capacite_heures": 8, "cout_heure": 55, "description": "Installation tuyauterie ABS, cuivre"},
    {"nom": "Plomberie finition", "departement": "PLOMBERIE", "capacite_heures": 8, "cout_heure": 58, "description": "Installation fixtures, robinetterie"},
    {"nom": "Test étanchéité", "departement": "PLOMBERIE", "capacite_heures": 4, "cout_heure": 55, "description": "Tests pression et étanchéité"},
    
    # ===== ÉLECTRICITÉ =====
    {"nom": "Électricité brute", "departement": "ÉLECTRICITÉ", "capacite_heures": 8, "cout_heure": 52, "description": "Câblage et boîtes électriques"},
    {"nom": "Panneau électrique", "departement": "ÉLECTRICITÉ", "capacite_heures": 6, "cout_heure": 65, "description": "Installation panneau et branchements"},
    {"nom": "Électricité finition", "departement": "ÉLECTRICITÉ", "capacite_heures": 8, "cout_heure": 50, "description": "Prises, interrupteurs, luminaires"},
    
    # ===== CHAUFFAGE VENTILATION =====
    {"nom": "Ductwork CVC", "departement": "CVC", "capacite_heures": 8, "cout_heure": 48, "description": "Installation conduits ventilation"},
    {"nom": "Unité chauffage", "departement": "CVC", "capacite_heures": 6, "cout_heure": 55, "description": "Installation thermopompe, fournaise"},
    {"nom": "Système ventilation", "departement": "CVC", "capacite_heures": 8, "cout_heure": 45, "description": "VRC, ventilateurs, grilles"},
    
    # ===== REVÊTEMENTS EXTÉRIEURS =====
    {"nom": "Revêtement vinyle", "departement": "REVÊTEMENT", "capacite_heures": 8, "cout_heure": 38, "description": "Pose revêtement vinyle ou aluminium"},
    {"nom": "Brique parement", "departement": "MAÇONNERIE", "capacite_heures": 8, "cout_heure": 50, "description": "Pose brique de parement"},
    {"nom": "Pierre naturelle", "departement": "MAÇONNERIE", "capacite_heures": 6, "cout_heure": 55, "description": "Installation pierre naturelle"},
    
    # ===== PORTES ET FENÊTRES =====
    {"nom": "Fenêtres", "departement": "MENUISERIE", "capacite_heures": 8, "cout_heure": 42, "description": "Installation fenêtres PVC, aluminium"},
    {"nom": "Portes extérieures", "departement": "MENUISERIE", "capacite_heures": 6, "cout_heure": 40, "description": "Installation portes d'entrée"},
    {"nom": "Portes intérieures", "departement": "MENUISERIE", "capacite_heures": 8, "cout_heure": 36, "description": "Installation portes intérieures"},
    
    # ===== FINITION INTÉRIEURE =====
    {"nom": "Gypse murs", "departement": "GYPSE", "capacite_heures": 8, "cout_heure": 32, "description": "Pose panneaux gypse murs"},
    {"nom": "Gypse plafonds", "departement": "GYPSE", "capacite_heures": 8, "cout_heure": 35, "description": "Pose panneaux gypse plafonds"},
    {"nom": "Joints gypse", "departement": "GYPSE", "capacite_heures": 8, "cout_heure": 30, "description": "Tirage joints et sablage"},
    {"nom": "Peinture préparation", "departement": "PEINTURE", "capacite_heures": 8, "cout_heure": 28, "description": "Préparation surfaces, primer"},
    {"nom": "Peinture finition", "departement": "PEINTURE", "capacite_heures": 8, "cout_heure": 32, "description": "Application peinture finie"},
    
    # ===== PLANCHERS =====
    {"nom": "Plancher flottant", "departement": "PLANCHER", "capacite_heures": 8, "cout_heure": 35, "description": "Installation plancher laminé/vinyle"},
    {"nom": "Céramique", "departement": "CÉRAMIQUE", "capacite_heures": 8, "cout_heure": 45, "description": "Pose carrelage céramique"},
    {"nom": "Tapis", "departement": "PLANCHER", "capacite_heures": 6, "cout_heure": 30, "description": "Installation tapis et sous-tapis"},
    
    # ===== FINITION SPÉCIALISÉE =====
    {"nom": "Armoires cuisine", "departement": "MENUISERIE", "capacite_heures": 8, "cout_heure": 48, "description": "Installation armoires et comptoirs"},
    {"nom": "Moulures finition", "departement": "MENUISERIE", "capacite_heures": 8, "cout_heure": 38, "description": "Plinthes, cadrages, moulures"},
    {"nom": "Quincaillerie", "departement": "MENUISERIE", "capacite_heures": 4, "cout_heure": 35, "description": "Poignées, serrures, accessoires"},
    
    # ===== NETTOYAGE ET FINITION =====
    {"nom": "Nettoyage chantier", "departement": "NETTOYAGE", "capacite_heures": 8, "cout_heure": 25, "description": "Nettoyage progressif chantier"},
    {"nom": "Nettoyage final", "departement": "NETTOYAGE", "capacite_heures": 8, "cout_heure": 28, "description": "Nettoyage complet livraison"},
    {"nom": "Inspection finale", "departement": "QUALITÉ", "capacite_heures": 4, "cout_heure": 65, "description": "Inspection qualité pré-livraison"},
    
    # ===== AMÉNAGEMENT EXTÉRIEUR =====
    {"nom": "Entrée asphalte", "departement": "PAVAGE", "capacite_heures": 6, "cout_heure": 40, "description": "Préparation et pavage entrée"},
    {"nom": "Aménagement paysager", "departement": "PAYSAGE", "capacite_heures": 8, "cout_heure": 32, "description": "Plantation, ensemencement, aménagement"},
    {"nom": "Clôtures", "departement": "MENUISERIE", "capacite_heures": 8, "cout_heure": 35, "description": "Installation clôtures bois/vinyle"},
    {"nom": "Terrasses balcons", "departement": "CHARPENTE", "capacite_heures": 8, "cout_heure": 40, "description": "Construction terrasses et balcons"}
]
        ...
        if count_result and count_result[0]['count'] == 0:
            ...
            for poste in POSTES_CONSTRUCTION_QUEBEC:
                db.execute_insert("""
                    ...
                    (nom, departement, capacite_heures_jour, cout_heure_standard, 
                     statut, type_poste, description)
                    VALUES (?, ?, ?, ?, 'ACTIF', 'CONSTRUCTION', ?)
                """, (
                    poste["nom"],
                    poste["departement"], 
...
def export_bt_html_streamlit(form_data: Dict) -> str:
    ...
    VERSION PROFESSIONNELLE avec design Constructo AI Inc.
    """
    ...
    <head>
        ...
        <style>
            ...
            * {{
            ...
            /* Logo styles removed - not needed anymore */
        ...
        <div class="container">
            ...
            <div class="header">
                <div class="company-info">
                    <div class="company-name">Constructo AI Inc.</div>
    ...
    html_template += f"""
            ...
            <!-- Pied de page -->
            <div class="footer">
                <div><strong>🏭 Constructo AI Inc.</strong> - Système de Gestion Production ERP</div>
...
def apply_dg_styles():
    """Applique les styles Constructo AI Inc. cohérents avec le HTML"""
    st.markdown("""
    <style>
    /* Variables Constructo AI Inc. */
    :root {
        --primary-color: #3B82F6;
        --primary-color-darker: #2563EB;
        --primary-color-darkest: #1D4ED8;
...
def show_dg_header():
    """Affiche l'en-tête Constructo AI Inc. comme dans le HTML"""
    st.markdown("""
    <div class="dg-header">
        <div class="dg-company-name" style="font-size: 1.8rem; font-weight: 700; color: var(--primary-color);">Constructo AI Inc.</div>
...
def show_tasks_section():
    ...
    try:
        ...
        operation_options = [
            '', 'Planification et conception', 'Préparation du terrain', 'Fondations et excavation', 
            'Structure et charpente', 'Toiture et étanchéité', 'Plomberie brute', 'Électricité brute', 
            'Isolation et pare-vapeur', 'Peinture et finition', 'Inspection finale'
        ]
...
def show_work_center_form(poste_data=None):
    ...
    with st.form("work_center_form"):
        ...
        with col1:
            ...
            departements = ['PRODUCTION', 'STRUCTURE', 'QUALITÉ', 'INGÉNIERIE', 'ADMINISTRATION', 'COMMERCIAL', 'DIRECTION']
            ...
            categories = ['TERRASSEMENT', 'BÉTON', 'OSSATURE', 'MÉCANIQUE', 'FINITION', 'MANUEL', 'INSPECTION']
        ...
        with col2:
            type_machine = st.text_input(
                ...
                placeholder="Ex: Pelle mécanique Caterpillar 320"
            )
        ...
        with chart_col1:
            ...
            if dept_data:
                ...
                fig_dept = px.pie(
                    ...
                    color_discrete_sequence=['#3B82F6', '#2563EB', '#f59e0b', '#ef4444', '#8b5cf6']
                )
...
def show_production_management_page():
    ...
    if 'gestionnaire_bt' not in st.session_state:
        if 'erp_db' in st.session_state:
            # INITIALISER POSTES CONSTRUCTION
            init_postes_construction_if_empty(st.session_state.erp_db)
    ...
    <div style='text-align:center;color:{footer_color};padding:20px 0;'>
        <p><strong>🏭 Constructo AI Inc.</strong> - Système de Gestion Production</p>
